...
function Contact() {
    return(
        <section id="contact" className="flex flex-col justify-start  w-screen max-h-max  bg-light dark:bg-silver pt-20 overflow-hidden">
    ...
    <form className="rounded-lg shadow-xl flex flex-col px-8 py-8 bg-white dark:bg-dark overflow-hidden">
