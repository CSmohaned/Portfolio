...
function Portfolio() {
  ...
  <section id="portfolio"className="flex-col flex justify-center items-center  w-screen max-h-max py-10 bg-[#f5f8fc] dark:bg-silver pt-5 overflow-hidden">
    <h2 className="text-center font-bold text-4xl text-[#666666] dark:text-[#FFFFFF]">My Projects</h2>
        ...
        <motion.div variants={show} initial="hidden" animate="visible"  transition={spring} whileHover={{scaleX: 0.8}}  id="carouselExampleCaptions" className="carousel slide relative border rounded-2xl bg-[#1A1A1A] dark:bg-dark pt-5 mt-10 pb-8 sm:mx-2"  data-bs-ride="carousel">
  ...
  <div className="">
     ...
     <motion.button transition={spring}  whileHover={{scale: 1.1}} type="button" className="sm:mb-2 inline-block sm:px-3 px-6 py-2 bg-[#0f57ff] text-[#fff] dark:text-[#fff] mr-2 font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-500 hover:shadow-lg focus:bg-blue-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-600 active:shadow-lg">NodeJS</motion.button>
     <motion.button transition={spring}  whileHover={{scale: 1.1}} type="button" className="sm:mb-2 inline-block sm:px-3 px-6 py-2 bg-[#0f57ff] text-[#fff] dark:text-[#FFFF] mr-2 font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-500 hover:shadow-lg focus:bg-blue-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-600 active:shadow-lg">ReactJs</motion.button>
     <motion.button transition={spring}  whileHover={{scale: 1.1}} type="button" className="sm:mb-2 inline-block sm:px-3 px-6 py-2 bg-[#0f57ff] text-[#fff] dark:text-[#FFFF] mr-2 font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-500 hover:shadow-lg focus:bg-blue-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-600 active:shadow-lg">MongoDb</motion.button>
     <motion.button transition={spring}  whileHover={{scale: 1.1}} type="button" className="sm:mb-2 flex flex-row sm:px-3 px-6 py-2 bg-[#0f57ff] text-[#fff] dark:text-[#FFFF] mr-2 font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-500 hover:shadow-lg focus:bg-blue-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-600 active:shadow-lg">GitHub <Link href="https://github.com/CSmohaned/A-Book-Tracking-App" scroll={false}><BsGithub className='inline ml-2 mr-3 hover:translate-x-1'/></Link></motion.button>
  </div>
  ...
  <div className="">
     <div className="flex justify-center items-center mt-3 sm:flex-col">
     <motion.button transition={spring}  whileHover={{scale: 1.1}} type="button" className="sm:mb-2 inline-block sm:px-3 px-6 py-2 bg-[#0f57ff] text-[#fff] mr-2 font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-500 hover:shadow-lg focus:bg-blue-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-600 active:shadow-lg">ReactJs</motion.button>
     <motion.button transition={spring}  whileHover={{scale: 1.1}} type="button" className="sm:mb-2 inline-block sm:px-3 px-6 py-2 bg-[#0f57ff] text-[#fff] mr-2 font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-500 hover:shadow-lg focus:bg-blue-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-600 active:shadow-lg">ReactJs</motion.button>
     <motion.button transition={spring}  whileHover={{scale: 1.1}} type="button" className="sm:mb-2 inline-block sm:px-3 px-6 py-2 bg-[#0f57ff] text-[#fff] mr-2 font-medium text-xs  leading-tight uppercase rounded-full shadow-md hover:bg-blue-500 hover:shadow-lg focus:bg-blue-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-600 active:shadow-lg">Udacity Project</motion.button>
     <motion.button transition={spring}  whileHover={{scale: 1.1}} type="button" className="sm:mb-2 flex flex-row sm:px-3 px-6 py-2 bg-[#0f57ff] text-[#fff] mr-2 font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-500 hover:shadow-lg focus:bg-blue-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-600 active:shadow-lg">GitHub <Link href="https://github.com/CSmohaned/Task-Management" scroll={false}><BsGithub className='inline ml-2 mr-3 hover:translate-x-1'/></Link></motion.button>
  </div>
